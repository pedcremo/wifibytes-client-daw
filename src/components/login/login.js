            ...
            <div>
                <div className="loginForm">
                    ...
                    <div className="login-acces">
                        ...
                        <input type="text" size="10" maxLength="9" className="loginInput" pattern="^[0-9]{8}[a-zA-Z]{1}$" value={this.state.username} onChange={(e)=>this.updateInput(e,'username')} placeholder={Utils.translate("login-acces-dni-form")}></input>
                        <h4>{Utils.translate("login-acces-password")}</h4>
                        <input type="password" className="loginInput" value={this.state.password} onChange={(e)=>this.updateInput(e,'password')} placeholder={Utils.translate("login-acces-password-form")}></input>

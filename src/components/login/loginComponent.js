  ...
  recoverPass() {
    if (this.props.captcha) {
      ...
      this.props.changeValue(
        Utils.translate("register-error-captcha"),
        "errorCaptcha"
      );
  }
  /** render  */
      ...
      <div className="loginForm">
        ...
        <div className="login-acces">
          <form>
            <span>
              ...
              <input
                ...
                placeholder={Utils.translate("login-acces-dni-form")}
              />
            </span>
            <span>
              ...
              <input
                ...
                placeholder={Utils.translate("login-acces-password-form")}
              />
            </span>
            <button
              ...
              onClick={ev => (
                ev.preventDefault(),
                login({ username_or_email: username, password: password })
              )}
            >
            ...
            <a
              ...
              className="login-button btn left"
              href={"#/register"}
            >
            ...
            {error ? (
              <p display={error ? "none" : "block"}>
                {"Not correct password or username"}
              </p>
            ) : (
              ""
            )}
          ...
          <p
            ...
            onClick={() => changeValue(!showRecoverPass, "showRecoverPass")}
          >
            {Utils.translate("login-text-recover")}
          </p>
          <div
            className={
              showRecoverPass ? "login-recuperar-input" : "login-recov-pass"
            }
          >
            <form className="login-recover">
              <span>
                <input
                  ...
                  placeholder={Utils.translate("login-recover-password")}
                />
                <button
                  onClick={ev => (
                    ev.preventDefault(), this.recoverPass(captcha, email)
                  )}
                  className="login-button btn"
                >
              ...
              <div id="captcha">
                <Reaptcha
                  ...
                  onVerify={() => changeValue(true, "captcha")}
                  onExpire={() => changeValue(false, "captcha")}

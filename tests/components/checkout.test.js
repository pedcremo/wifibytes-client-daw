...
describe('Reducer', () => {
  ...
  it('should handle EMPTY_CHILD', () => {
    mockStore(initialState);
    expect(
        currentCheckout(undefined, {
          type: checkoutActions.EMPTY_CHILD,
          payload: {
            key: 'personal_data',
            data: {
              datosPersonales: {
                ...
                'cuenta': 'dsfgdsfgd',
                'tipcli': '0',
                'preview': 'data:image/png;base64,iVBORwGgQEREREZHJMdEgIiIi'},
              datosProductos: [
                {
                  'key': 0,
                  'tipo': 'alta',
